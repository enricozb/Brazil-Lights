...
rooms = {
    "test": {
        "1f": "02001fff",
        "idk": "140044696d6d657220530250ff",
    },
    "general": {
        "on": "020000ff",
        "off": "020001ff",
    ...
    "enrico": {
        "center": "020016ff",
        "window": ("020017ff", "140044696d6d6572205304{:02x}ff"),
        "off": "020018ff",
    },
    "marina": {
        "center": "020012ff",
    ...
    "outside": {"counter": "020010ff", "main": "02000fff", "off": "020011ff"},
    "living room": {
    ...
    "game room": {"center": "020021ff", "lateral": "020022ff", "off": "020023ff"},
    "master bedroom": {
        "center": "020019ff",
        "lateral": "02001aff",
...
def send_bytes(data):
    with open("/tmp/brazil-light-packet", "wb") as out:
        out.write(data)
    call(
        f"cat /tmp/brazil-light-packet | socat - UDP-DATAGRAM:255.255.255.255:8760,broadcast",
        shell=True,
    )
